...
//testaConexao();
//var_dump(insereRegistro("insert into aluno(nmaluno) values('aula online')"));
//var_dump(selectRegistros('SELECT * FROM ALUNO'));
//deleteRegistro("DELETE FROM login WHERE dslogin='afdsfdsfsf'");
//var_dump(updateRegistro('update login set dslogin="atafack" where idaluno = 9'));
